...
namespace LineUp2
{
    public class Grid
    {
        ...
        /// </summary>
        /// GameConfig.GameMode gameMode = GameConfig.GameMode.Classic,GameConfig.PlayerMode playerMode = GameConfig.PlayerMode.HvH
        public void DrawGrid(int FrameDelay=500)
        {
